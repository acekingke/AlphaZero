...
def main():
    ...
    play_parser.add_argument('--mcts_simulations', type=int, default=800, help='Number of MCTS simulations')
    ...
    eval_parser.add_argument('--mcts_simulations', type=int, default=100, help='Number of MCTS simulations')
    ...
    compare_parser.add_argument('--mcts_simulations', type=int, default=100, help='Number of MCTS simulations')
